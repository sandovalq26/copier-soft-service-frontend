...
import {type ClienteDTO, getAllClients} from '../api/clientService';
import {getAllPhotocopiers} from '../api/photocopierService';
import {createRental, updateRental, getRentalById, type FotocopiadoraDTO} from '../api/rentalService';
                            ...
                            <div className="form-card-body">
                                <div className="row g-3">
                                    <div className="col-md-6">
                                        ...
                                        <select className="form-select" id="rentCliente" name="clienteId" required
                                                defaultValue="">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input type="date" className="form-control" id="rentFechaInicio"
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <input type="date" className="form-control" id="rentFechaFin" name="fechaFin"
                                               required/>
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <select className="form-select" id="rentPeriodo" name="periodo" required
                                                defaultValue="DIA">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="input-group">
                                            ...
                                            <input type="number" step="0.01" className="form-control" id="rentPrice"
                                                   name="price"
                        ...
                        <div className="form-card">
                            ...
                            <div className="form-card-body">
                                <div className="mb-3">
                                    ...
                                    <select className="form-select" id="rentEstado" name="estado"
                                ...
                                <div className="table-responsive">
                                    <table className="table table-hover mb-0" id="photocopierTable">
                                            ...
                                            <tr key={f.codFotocopiadora}>
                                                ...
                                                <td className="text-center">
                                                    <button type="button" className="btn btn-sm btn-outline-danger"
                                                            title="Quitar"
                                                            onClick={() => handleRemovePhoto(f.codFotocopiadora)}>
                                        ...
                                        {selectedPhotos.length === 0 && (
                                            <tr>
                                                <td colSpan={9} className="text-center py-4 text-muted">No se han
                                                    asignado equipos.
                                                </td>
                                            </tr>
                                        )}
